      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-end items-center">
            ...
            <NavLink
              to="/admin"
              className="font-medium tracking-wide py-2 px-5 sm:px-8 border border-blue-500 text-blue-500 bg-white-500 outline-none rounded-l-full rounded-r-full capitalize hover:bg-blue-500 hover:text-white-500 transition-all hover:shadow-blue hover:text-white"
            >
              Admin
            </NavLink>
          </div>
